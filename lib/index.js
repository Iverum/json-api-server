  ...
  _createClass(ApiServer, [{
    ...
    value: function start() {
      ...
      Promise.all(_lodash2.default.map(this.resources, function (resource) {
        ...
        _lodash2.default.forOwn(_this.resources, function (value, key) {
          server.get('/' + key, _this.authenticator, value.routes.getAll);
          server.get('/' + key + '/:id', _this.authenticator, value.routes.get);
          server.post('/' + key, _this.authenticator, value.routes.create);
          server.patch('/' + key + '/:id', _this.authenticator, value.routes.update);
          server.del('/' + key + '/:id', _this.authenticator, value.routes.delete);
        });
